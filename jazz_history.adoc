...
If you link:#setup[recreated the database], you can run these queries against your instance by simply cutting and pasting them into the prompt, as shown below.
image::images/cypher_in.png[]
